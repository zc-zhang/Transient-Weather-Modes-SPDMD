function [ KModes,KEv,Norms,XCdmd ] = CompanionMatrix_DMD( Data )
...
%[Norms, ind]=sort(real(KEunsrtd),'descend');          %% %% sorting based on ke
...
XCdmd = KModes * Vandermonde;  %% Reconstructed data
