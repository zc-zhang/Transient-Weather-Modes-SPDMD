...
for i = 1:121
    ...
    vorticity_y = dW_dy - dV_dz;
    vorticity_z = dV_dy - dW_dz;
...
% Calculate the stream function
    %psi = cumsum(vorticity_y, 1) * dz - cumsum(vorticity_z, 2) * dy;
      ...
      magnitude_vorticity = sqrt(vorticity_y.^2 + vorticity_z.^2);
